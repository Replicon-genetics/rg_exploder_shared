...
<div>
  ...
  <div class="container">
    <div class="container__child">
      <h3>{{ "Select "+jsonConfig.bio_parameters.target_transcript_name.label+" Range" }}</h3>
      <div class="container__child-subtitle">
      </div>
        <BaseNumberInputWide
      ...
      <BaseNumberInput
        ...
        :label="tbv_trans_Begin_ext.label"
